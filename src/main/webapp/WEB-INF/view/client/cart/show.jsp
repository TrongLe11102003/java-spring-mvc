                        ...
                        <tbody>
                            <c:forEach var="cartDetail" items="${cartDetails}">
                                <tr>
                                    <td>
                                        <div class="mt-4">
                                            <input class="form-check-input" type="checkbox" name="cartDetailIds" value="${cartDetail.id}">
                                        </div>
                                    </td>
                                    
                                    <input type="hidden" name="idArray" value="${cartDetail.id}"/>
                                    <input type="hidden" id="quantity-${cartDetail.id}" name="quantityArray" value="${cartDetail.quantity}"/>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-md rounded-circle bg-light border mt-4" onclick="handleDelete('${cartDetail.id}')">
