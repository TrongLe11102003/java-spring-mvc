              ...
              <div class="row">
                <div class="col-md-8 col-12 mx-auto">
                  ...
                  <div class="d-flex gap-5 mb-3">
                     <h4>Order id = ${newOrder.id}</h4>
                     <h4>Price: <fmt:formatNumber value="${newOrder.totalPrice}" type="number"/> đ</h4>
                  </div>
                  <hr />
                  ...
                  <form:form method="post" action="/admin/order/update" modelAttribute="newOrder">
                    ...
                    <div class="row g-3">
                        <div class="mb-3 col-12 col-md-6">
                          ...
                          <input type="text" class="form-control" value="${newOrder.user.fullName}" disabled />
                        </div>
